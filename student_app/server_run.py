...
# Ce middleware est appliqué à l'application principale
origins = [
    "https://preprod.upenn.my-lucy.com",
    "http://localhost:3000", 
    "http://localhost:3001", 
    "http://localhost:5173",
    "https://upenn.my-lucy.com",
]

app.add_middleware(  # <--- CE MIDDLEWARE S'APPLIQUE GLOBALEMENT
    CORSMiddleware,
